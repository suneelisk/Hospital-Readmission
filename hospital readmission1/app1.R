                      ...
                      fluidRow(fluidPage(theme="bootstrap.min.css",
                                         ...
                                         tabBox ( width = 2000, height = 5500,
                                                  ...
                                                  tabPanel("Output", p("The aim of this application is to Predict will patient readmitted or not...",
                                                           ...
                                                           box( width = 100,
                                                                title = "will patient readmitted with in a month ? ",status = "primary", solidHeader = TRUE,collapsible = TRUE,
                                                                dataTableOutput("y_cap"))), 
                                                  
                                                  
                                                  tabPanel("Likely to Readmitted with in a month",
                                                           box( width = 20,
                                                                title = "Likely to Readmitted with in a month ",status = "success", solidHeader = TRUE,collapsible = TRUE,
                                                                dataTableOutput("rrr"))), 
                                                  
                                                  
                                                  tabPanel("Likely to Readmitted after a month", 
                                                           box( width = 20,
                                                                title = "Likely to Readmitted after a month",status = "danger", solidHeader = TRUE,collapsible = TRUE,
                                                                dataTableOutput("yyy")))
                                         )
